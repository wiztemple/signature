    ...
    <div className={`lg:rounded-[50px] rounded-[20px] font-nunitoSans relative lg:h-[410px] overflow-hidden ${bannerBg}`}>
      ...
      <div className='text-primaryblack lg:px-10 p-4 flex md:flex-row flex-col-reverse h-full items-center relative justify-between'>
        <div>
          ...
          <Link to="https://aos.signaturebankng.com/" target="_blank" style={{ backdropFilter: "blur(50px)" }} className={`${buttonStyle} block w-fit lg:mt-12 mt-6 text-lg px-6 py-4 ease-in-out duration-75 delay-75 transition-all rounded-[10px]`}>{buttonName}</Link>
        </div>
