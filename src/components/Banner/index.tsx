...
const Banner = ({
  ...
  return (
    <div className={`lg:rounded-[50px] rounded-[20px] font-nunitoSans relative lg:h-[410px] overflow-hidden ${bannerBg}`}>
      <img className="absolute w-[2000px] h-[1500px] rotate -top-96 left-10" src="https://framerusercontent.com/images/lrpi5BupBslKQxBnserqWJ30fDs.png" alt="" />
      ...
      <div className='text-primaryblack lg:px-10 p-4 flex md:flex-row flex-col-reverse h-full items-center relative justify-between'>
        <div>
          ...
          <div
            className={`text-[20px] ${textColor} md:text-2xl mt-5 md:w-[80%]`}
          >
            {description}
          </div>
          <button
            className={`${buttonStyle} backdrop-blur-[50px] lg:mt-12 mt-6 text-lg px-6 py-4 rounded-[10px]`}
          >
            {buttonName}
          </button>
        </div>
