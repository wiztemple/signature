...
const Board = ({title, description}: BoardProps) => {
    return (
        <div className="text-primaryblack h-[500px] overflow-hidden relative bg-main-7">
            ...
            <div className="flex relative flex-col h-full items-center justify-center pt-20">
                <h1 className="lg:text-[72px] w-[60%] leading-[1.3em] text-center text-[36px] font-bold text-black">{title}</h1>
                <p className="text-lg w-[60%] text-center leading-[28px] lg:mt-0 mt-2 text-hex-11">{description}</p>
            </div>
        </div>
    );
};
