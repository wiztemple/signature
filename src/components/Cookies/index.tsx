...
const CookiesP = () => {
  ...
  return (
      <div>
        ...
        <div style={{ backdropFilter: "blur(20px)", backgroundColor: "rgba(255, 255, 255, 0.7)" }} className="h-auto lg:w-[45%] w-[80%] rounded-[16px] justify-center fixed bottom-3 z-50">
          <div className="relative flex lg:flex-row flex-col items-center justify-between py-2 px-3">
            <div className="flex lg:flex-row flex-col gap-4 items-center">
              ...
              <p className="text-main-4 text-sm lg:text-start lg: text-center leading-[1.5em] lg:w-[80%]">We use cookies to give you the best online experience. Find out more on how we use cookies in our <a href="/cookies" className="text-hex-2">cookie policy</a></p>
            </div>
