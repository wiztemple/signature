...
const locations: { name: string; url: string }[] = [
  {
    ...
    url: "https://maps.google.com/maps?q=4.817687060480532,7.009801497683675&z=14&output=embed",
  },
  {
    name: "31b Gana Street Maitama",
    url: "https://maps.google.com/maps?q=9.080039249330586,7.500609953041856&z=14&output=embed",
  },
  {
    name: "Aba-1B Factory Road Aba",
    url: "https://maps.google.com/maps?q=5.1205557139818625,7.368289486509419&z=14&output=embed",
  },
  {
    name: "Umuahia-2 Library Avenue",
    url: "https://maps.google.com/maps?q=5.52426917346189,7.490834925110713&z=14&output=embed",
  },
  {
    name: "Asaba-119 Nnebisi Road2",
    url: "https://maps.google.com/maps?q=6.195058723258716,6.740262638605889&z=14&output=embed",
  },
];
...
const BranchLocator = () => {
  ...
  const [locator, setLocator] = useState<string>(
    "https://maps.google.com/maps?q=9.080039249330586,7.500609953041856&z=14&output=embed"
  );
  ...
  return (
    <div className="bg-white font-nunitoSans">
      ...
      <div className="text-primaryblack md:h-[60vh] h-screen lg:h-[90vh] overflow-hidden relative bg-main-7 pt-32">
        <img
          className="absolute lg:-bottom-10 md:bottom-10 bottom-0 md:right-44 right-0 md:w-[80%] h-screen w-full"
          src="https://framerusercontent.com/images/lrpi5BupBslKQxBnserqWJ30fDs.png"
          alt=""
        />
        <div className="flex relative flex-col h-full items-center justify-center font-nunitoSans">
          <h1 className="md:text-[72px] w-[60%] leading-[1.3em] text-center text-[36px] font-bold text-black">
            Contact Us
          </h1>
          <p className="text-lg md:w-[40%] sm:w-[60%] w-[90%] text-center leading-[1.7em] lg:mt-0 mt-2 text-hex-11">
            Need assistance with a specific transaction or issue? Our customer
            support team is available to help you resolve them.
          </p>
          <div className="flex items-center pt-14">
            <img
              className="h-[232px] w-[207px] md:block hidden bg-cover object-cover rounded-[88px]"
              src="https://framerusercontent.com/images/fx0irxFFH7ZTEIeprqU9seNNzHM.png?scale-down-to=512"
              alt=""
            />
            ...
            <div className="relative h-[232px] md:-ml-[116px] md:w-[500px] sm:w-[400px] w-[350px]">
              <img
                className="h-full w-full absolute bg-cover object-cover rounded-[88px]"
                src="https://framerusercontent.com/images/oYa3Hb3tW3oxYrJMJm1aWUVqM.jpg?scale-down-to=1024"
                alt=""
              />
            </div>
      ...
      <div>
        <div className="lg:w-[70%] w-[90%] mx-auto py-20">
          <div className="font-nunitoSans flex flex-col items-center">
            <h1 className="md:text-[48px] text-[30px] text-center md:w-full w-[80%] text-primaryblack font-bold">
              We Would Love To Hear From You
            </h1>
            <p className="text-primarygray text-lg lg:w-[55%] md:w-[80%] sm:w-[62%] w-[80%] lg:mt-0 md:mt-2 mt-4 text-center">
              we have a ruputation of offering a seamless banking experience
              that promotes good relationship with our customers
            </p>
          </div>
          <div className="flex md:flex-row flex-col md:items-start items-center lg:gap-20 gap-5 mt-16">
              <div className="flex md:items-start items-center flex-col gap-4">
                <ZoomOnScroll>
                  <CompanyInformation
                    ...
                    details="Customer Service Support:"
                    extraDetails="customercare@signaturebankng.com"
                  />
                </ZoomOnScroll>
                <ZoomOnScroll>
                  <CompanyInformation
                    ...
                    extraStyle="md:w-[457px] sm:w-[70%] w-full lg:p-[40px] p-5"
                    title="For enquiries"
                    details="Corporate & Brand Enquiries:"
                ...
                <ZoomOnScroll>
                  <CompanyInformation
                    ...
                    extraDetails="Signature Bank Limited, 31B Gana Street, Maitama, Abuja FCT, Nigeria."
                  />
                </ZoomOnScroll>
                <ZoomOnScroll>
                  <CompanyInformation
            ...
            <div className="md:w-full sm:w-[70%] w-[90%] font-nunitoSans">
              <h2 className="text-primaryblack text-[36px] text-center font-bold leading-[44px]">
                Get in touch
              </h2>
              <p className="text-primarygray text-xl leading-[30px] text-center mt-3">
              ...
              <ZoomOnScroll>
                <form className="mt-4">
                  ...
                  />
                  <div>
                    <label className="text-xs text-black font-medium font-nunito">
                      Your Enquiry
                    </label>
                    <select
                      ...
                      placeholder="Your name"
                    >
                      <option value="Select Your Enquiry">
                        Select Your Enquiry
                      </option>
                      <option value="Dispence/Transfer Error">
                        Dispence/Transfer Error
                      </option>
                      ...
                      <option value="Shareholder Enquiry">
                        Shareholder Enquiry
                      </option>
                  ...
                  <button className="bg-hex-2 text-white py-3 px-5 text-xs mt-4 font-bold rounded-[10px]">
                    Submit
                  </button>
                </form>
              </ZoomOnScroll>
      ...
      <div>
        <div className="lg:w-[85%] md:w-[90%] sm:w-[70%] w-[90%] mx-auto">
          <div className="font-nunitoSans flex flex-col items-center">
            <h1 className="md:text-[48px] text-[30px] text-primaryblack text-center font-bold">
              There is a branch nearby
            </h1>
            <p className="text-primarygray text-lg lg:w-[45%] md:w-[50%] w-[95%] mt-3 text-center">
              Find our nearest branch and ATM locations for convenient and
            ...
            >
              {locations.map((location, index) => (
                <div
                  ...
                  className={`${
                    activeIndex === index
                      ? "bg-hex-15 text-hex-2"
                      : "bg-hex-14 text-alternate"
                  } cursor-pointer ease-in-out transition-all duration-500 delay-150 h-[150px] pt-[30px] flex flex-col items-center gap-4 pb-5 px-[10px] rounded-[20px]`}
                >
                  {activeIndex === index ? (
                    <img src={locatorSvg1} alt="" />
                  ) : (
                    <img src={locatorSvg} alt="" />
                  )}
                  <p className="text-base lg:w-[60%] text-center font-nunito">
                    {location.name}
                  </p>
                </div>
              ))}
