  ...
  return (
    <div className="bg-white">
      ...
      <div className="bg-white text-black">
        <div className="w-[85%] mx-auto">
          <div className="flex justify-between py-28">
            <div className="text-[40px] w-[45%] leading-[1.2em] font-bold text-[#101828] font-nunitoSans">Banking services designed to grow your business</div>
            <div className="w-[340px] text-[#555d68] text-lg font-nunitoSans">Empowering you with the tools to drive your business forward and achieve your goals.</div>
          </div>
      ...
      <div className="bg-[#fcf8fb] text-black py-20">
        <div className="w-[85%] mx-auto">
          <h1 className="text-[#0f1728] text-[48px] font-nunitoSans font-bold leading-[-0.96px] text-center">Built for the future, built for your progress.</h1>
          <p className="text-center text-2xl text-[#101828] mt-3 mb-20 font-nunitoSans">We take pride in offering you a superior banking experience</p>
          <SectionCard
          black="primaryblack"
          buttonBg=""
          buttonColor=""
