    ...
    <div className="bg-white">
      ...
      <div className="bg-main-7 h-screen overflow-hidden">
        <div className="flex justify-between items-center h-full text-primaryblack w-[85%] mx-auto">
          <div className="mt-28">
            <h1 className="text-[72px] w-full font-nunito text-hex-2 leading-[1.3em] font-bold">Make Your Mark with Signature Bank</h1>
            <button className="bg-hex-2 px-4 py-2 rounded-[10px] text-white mt-4 font-nunito">See Openings</button>
          </div>
      ...
      <div className="w-[85%] mx-auto">
        <div className="flex justify-between items-center h-[500px]">
          ...
          <div className="text-hex-9 flex-1 flex flex-col gap-5 font-nunito text-lg">
      ...
      <div className="bg-main-7">
        <div className="w-[80%] mx-auto py-20">
          <div className="flex flex-col items-center">
            <h2 className="text-primaryblack text-[48px] font-nunito font-bold">Your Next Big Career Move</h2>
          ...
          <div className="flex py-16 gap-24">
            <div className="flex-1">
              <div>
                ...
                <h3 className="text-primaryblack text-[28.56px] mt-5 leading-[1em] font-bold font-nunito">Management Trainee</h3>
                ...
                <button className="bg-hex-2 px-4 py-2 rounded-[10px] text-white mt-4 font-nunito">No Job Opening(s)</button>
              </div>
            </div>
            <div className="flex-1">
              <div>
                ...
                <h3 className="text-primaryblack text-[28.56px] mt-5 leading-[1em] font-bold font-nunito">Experienced Hires</h3>
