    ...
    <div className="bg-hex-7">
      ...
      <div className="h-screen w-full overflow-hidden font-nunitoSans">
        <div className="w-full mx-auto relative flex justify-center">
          <img className=" absolute top-14 -right-10 w-[90%] z-20" src="https://framerusercontent.com/images/yaKi2r9uBWv0fG5wicgNzHmYU.png?scale-down-to=2048" alt=""
          />
        </div>
        ...
        >
          ...
          >
            ...
            <p
              className="text-2xl font-nunitoSans flex justify-center text-center mt-4 text-white"
            >
              <p className="">Do your transactions anytime, anywhere you want.</p>
            </p>
          </div>
        </div>
        <div
          style={{ background: "linear-gradient(rgba(68, 11, 41, 0) 0%, rgb(68, 11, 41) 100%)" }}
      ...
      <div className="w-[85%] mx-auto mt-10">
        ...
        <div className="bg-[#6c1d45]/20 w-full h-[550px] overflow-hidden flex flex-col items-center">
          ...
          <div>Get our safe and durable signature card for your business transactions.</div>
          <button type="button" className="bg-primaryyellow text-lg text-white py-4 px-7 mt-5 rounded-[10px]">Learn More</button>
          <div className="w-full flex justify-center relative h-full">
            ...
            <div className="w-[24%] rotate-60 rounded-[20px] absolute -bottom-5 border">
              <img className="w-full h-[400px] object-fill bg-center" src="https://framerusercontent.com/images/YPez6dHwfFEyzqWU5wbuNGWLAs.png?scale-down-to=1024" alt="" />
            </div>
          </div>
        </div>
        {/*  */}
        <div className="grid grid-cols-2 gap-10 mt-20">
          ...
          <div className=" rounded-[30px] py-10 px-6 h-[810px] overflow-hidden bg-[#6c1d45]/20 from-[rgb(94,15,56)] via-transparent to-[rgb(65,10,39)]">
            ...
            <div className="gap-4 flex justify-center mt-24">
              <img className="w-[72%] object-cover bg-cover bg-no-repeat" src="https://framerusercontent.com/images/7bvEdP86K1ntVnA6USBkG21iEE.png" />
            </div>
          </div>
        </div>
      </div>
