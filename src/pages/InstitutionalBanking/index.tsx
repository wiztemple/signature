       ...
       <div className="bg-white text-black">
        <div className="w-[85%] mx-auto">
          <div className="flex justify-between py-28">
            <div className="text-[40px] w-[45%] leading-[1.2em] font-bold text-[#101828] font-nunito">Banking solutions that deliver growth and sustainability.</div>
            <div className="w-[340px] text-[#555d68] text-lg font-nunito">With a commitment to excellence, we offer tailored solutions designed to meet the specific requirements of large institutions with diverse banking needs.</div>
          </div>
