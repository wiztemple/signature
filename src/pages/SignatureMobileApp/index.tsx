        ...
        <div className="bg-white font-nunitoSans">
            ...
            <div className="text-primaryblack w-[85%] mx-auto">
                <div className="flex lg:flex-row flex-col justify-between pt-28 pb-20 items-center">
                    <div className="lg:flex-1">
                        <h2 className="text-alternate lg:w-[65%] text-[40px] leading-[1.3em] font-bold">The Signature Mobile App- the freedom to bank on-the-go</h2>
                    </div>
                    <div className="text-hex-9 flex-1 flex flex-col lg:mt-0 mt-4 gap-5 text-lg">
                        <p>Signature mobile is a smart banking app built to deliver the most seamless digital banking user experience with an extensive bouquet of functionalities for all users. The app is built as an electronic channel for potential and existing customers to bank on-the-go whilst performing financial transactions and lifestyle payments. This implies that potential customers can also open accounts through the app and enjoy the freedom to bank on-the-go.</p>
                    </div>
                </div>
                    ...
                    {names.map((name) => (
                        <div className="bg-cardbg relative w-full h-auto rounded-[20px] p-[20px]">
                            <div className="bg-hex-2/10 w-[95px] h-[95px] rounded-[20px]">
                                <img className="w-full h-full" loading="lazy" src="https://framerusercontent.com/images/h3MO2XZZjK008vmUX35AGUw2DY.png" alt="icon" />
                            </div>
                            <p className="text-primaryblack text-2xl w-[90%] mt-6 font-bold leading-[1.2em]">{name.name}</p>
                        </div>
                    ))}
                </div>
            </div>
            <div className="bg-main-9 py-28 md:my-24">
                <div className="w-[85%] mx-auto">
                    <h2 className="text-[48px] font-bold leading-[-0.96px] text-primaryblack text-center md:w-[60%] mx-auto">How to register on the Signature Mobile App</h2>
                    <div className="md:flex mt-14 gap-14">
                        <div className="flex-1">
                            <img className="w-full h-64 rounded-[20px] bg-cover object-cover" src="https://framerusercontent.com/images/AUKHC7JkfeujrNdtmTTenk5nY.jpg?scale-down-to=512" alt="" />
                            <p className="text-[28.56px] text-primaryblack leading-[1em] font-bold mt-6">For existing bank customers</p>
                        ...
                        <div className="flex-1 md:mt-0 mt-14">
                            <img className="w-full h-64 rounded-[20px] bg-cover object-cover" src="https://framerusercontent.com/images/ptvs2cLI1UEsfZl4LVrdQD3GRIY.jpg?scale-down-to=1024" alt="" />
                            <p className="text-[28.56px] text-primaryblack leading-[1em] font-bold mt-6">For existing bank customers</p>
                            {customers.map((customer, index) => (
                                <div key={index} className="flex gap-2 items-start mt-4">
                                    <img src={tickSvg} alt="good icon" />
                                    <p className="text-hex-9 text-base w-[80%]">{customer.title}</p>
                                </div>
                            ))}
                            <div className="flex gap-5 items-center mt-5">
                                <a target="_blank" rel="noopener" href="https://play.google.com/store/apps/details?id=ng.gov.cbn.speed.wallet.temp">
            ...
            <div className="lg:w-[85%] w-[90%] mx-auto pb-14">
                <div>
                    <h2 className="text-5xl text-primaryblack font-bold text-center pt-10 tracking-[-0.96px]">Frequently asked questions</h2>
